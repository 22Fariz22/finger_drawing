...
"""
done! размеры камеры должны передаватся в размеры черепашьего холста
done! сделать курсор
done! сделать чтобы когда большой и указательный были сомкнуты  - курсор не рисовал 
done! добавить палитру красок сбоку,чтобы прикосновением можно было менять цвет
done! сделать кнопку чтобы нашатие мышкой можно было сохранить
сделать программу под виндовс и макос
